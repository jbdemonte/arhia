...
function Employee() {
  ...
  self._define('nir', 'sal_nir', types.string);

  self._define('registrationNumber', 'sal_matricule', types.re(/^[a-z0-9]{1,30}$/i));

  self._define('birthPlace', 'sal_naissance_commune_nom', types.string);
  self._define('birthDate', 'sal_naissance_date', types.dateString);
  self._define('birthCountryISOCode', 'sal_naissance_pays_code', types.string);

  self._define('city', 'sal_adresse_commune_nom', types.string);
  self._define('address', 'sal_adresse_voie_desc', types.string);
  self._define('addressCpl', 'sal_adresse_voie_cplt', types.string);
  self._define('addressCCpl', 'sal_adresse_constr_cplt', types.string);
  self._define('postalCode', 'sal_adresse_codepostal', types.string);
  self._define('addressCountryISOCode', 'sal_adresse_pays_code', types.string);

  self._define('nationalityISOCode', 'sal_nationalite_code', types.string);
  self._define('externalId', 'sal_id_externe', types.re(/^[a-z0-9]{1,30}$/i));
