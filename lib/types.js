...
/**
 * Convert a period / formatted period to a ARHIA string period
 * @param {Date|string} value
 * @returns {string}
 */
module.exports.periodString = function (value) {
  var type = typeof value;
  if (type === 'object' || type === 'string') {
...
/**
 * Regex to remove characters not allowed before sent to arhia.
 */
module.exports.regAddress = /[,°]/g;